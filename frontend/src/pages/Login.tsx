  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <p className="text-xs text-slate-500">Sign in to your Supportly AI dashboard</p>
      </div>
        ...
        <Card className="p-8 space-y-6 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input
              label="Email Address"
              type="email"
              placeholder="admin@supportly.ai"
              value={email}
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <NavLink to="/forgot-password" className="text-xs font-semibold text-brand-600 hover:underline">
                  Forgot password?
                </NavLink>
              </div>
            </div>
          ...
          {/* Google SSO OAuth branded button */}
          <Button
            variant="outline"
            className="w-full justify-center text-xs"
            onClick={() => {
              setEmail('admin@supportly.ai');
